...
enum ImGuiInputFlags_
{
    ...
    ImGuiInputFlags_RouteFocused        = 1 << 8,   // (Default) Register focused route: Accept inputs if m_Window is in focus stack. Deep-most focused m_Window takes inputs. ActiveId takes inputs over deep-most focused m_Window.
    ImGuiInputFlags_RouteGlobalLow      = 1 << 9,   // Register route globally (lowest priority: unless a focused m_Window or active item registered the route) -> recommended Global priority.
