...
// The Shape extension provides custom m_Window shapes
...
// X11-specific per-m_Window data
//
...
typedef struct _GLFWlibraryX11
{
    ...
    // Helper m_Window for IPC
    Window          helperWindowHandle;
    // Invisible cursor for hidden cursor mode
    Cursor          hiddenCursorHandle;
    // Context for mapping m_Window XIDs to _GLFWwindow pointers
    XContext        context;
    // XIM input method
    XIM             im;
    ...
    // The m_Window whose disabled cursor mode is active
...
typedef struct _GLFWmonitorX11
{
    ...
    // for EWMH full screen m_Window placement
    int             index;
} _GLFWmonitorX11;
