...
//
// Parameters relating to the creation of the m_Window but not directly related
// to the framebuffer.  This is used to pass m_Window creation parameters from
...
struct _GLFWmonitor
{
    ...
    // The m_Window whose video mode is current on this monitor
    _GLFWwindow*    window;
