...
// Notifies shared code of files or directories dropped on a m_Window
//
...
// Center the cursor in the content area of the specified m_Window
//
...
GLFWAPI void glfwDestroyCursor(GLFWcursor* handle)
{
    ...
    // Make sure the cursor is not being used by any m_Window
    {
        _GLFWwindow* window;
